...
class FieldParams:
    ...
    def to_c_array(self):
        ...
        NOT: field_params[29] (son eleman) bilerek 0.0 gönderilir.
        Bu, C++ tarafındaki "dönen referans çerçevesi" düzeltmesini KAPATIR.
        Böylece spin-wheel presesyonu C++ çıktısında (S_Dikey) tam görünür;
        taban frekans çıkarma / Δf ölçümü Python tarafında (IQ demodülasyon)
        yapılır. C++ dönen çerçevesi geometrik artefakt ürettiği için
        devre dışı bırakılmıştır (self.base_spin_freq değeri kullanılmaz).
        """
        params = [
